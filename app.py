...
# def get_health_summary(textinput):
#     """
#     Generate a health summary using Gemini API based on symptom inputs.
#     """
#     prompt = f"""You are an AI medical assistant. Provide a summary based on the following symptoms:
#     {textinput}

#     Include:
#     - Possible causes or conditions
#     - Suggested actions (e.g., rest, hydration, doctor consultation)
#     - Severity level (mild, moderate, severe)
#     - Whether immediate medical attention is recommended
#     - Budget-friendly remedies or treatments if applicable
#     """

#     model = genai.GenerativeModel("gemini-1.5-flash")
#     response = model.generate_content(prompt)
#     return response.text if response else "No health summary generated."

# st.title("AI-Health Bot")
# st.write("Get Suggestions here")

# # User Inputs
# textinput = st.text_input("symptoms")
# textinput = st.markdown("""
#     <style>
#     .form{
#         width:1000px;
#     }
...
#    user_input = f"input:{textinput}"
#    disease = get_health_summary(user_input)
#    st.subheader("Disease is")
#    st.write(disease)
...
#     else:
#         # Format prompt
#         user_input = f"Starting: {textinput}"
#         model = genai.GenerativeModel("gemini-1.5-flash")
#         # Generate response
